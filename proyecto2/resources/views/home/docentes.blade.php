    ...
    <section class="py-4 md:py-8 flex mx-auto items-center container">
        <div class="m-8 px-4 w-1/2">
            <div class="text-center">
                ...
                <p class="font-normal text-gray-600 text-md md:text-base mb-16">Descripcion del docente: Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quaerat distinctio aliquid porro, beatae quis et voluptate sint animi? Tempora, saepe et hic excepturi ut nesciunt.</p>
            </div>
        </div>
        <div class="m-8 px-4 w-1/2">
